...
that we're subtracing a suspicious-looking constant from `CX` - `0x076C` - which happens to be 1900!
...
As per its data sheet[^m5832], this chip is an RTC IC with a 4-bit address and data bus. 
